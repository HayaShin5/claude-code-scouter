...
description: Review an OpenSpec artifact for quality, consistency, and completeness. Use when the user wants to review proposal, specs, design, or tasks artifacts before proceeding.
license: MIT
...
3. **Determine which artifact to review**
   ...
   If the user specifies an artifact name, review that specific artifact.
